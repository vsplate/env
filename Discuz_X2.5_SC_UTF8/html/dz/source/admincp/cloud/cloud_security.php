...
$_GET['anchor'] = in_array($_GET['anchor'], array('index', 'setting', 'thread', 'post', 'safe', 'reportOperation')) ? $_GET['anchor'] : 'index';
...
$securitynav[4] = array('security_safe_list', 'cloud&operation=security&anchor=safe', $current['safe']);
