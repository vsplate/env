 ...
 *
 *      $Id: post_newreply.php 32761 2013-03-07 03:34:31Z monkey $
 */
		...
		if(!empty($_GET['addfeed']) && $_G['forum']['allowfeed'] && !$isanonymous) {
			if($special == 2 && !empty($_GET['trade'])) {
				...
				$feed['body_data'] = array(
					'itemname'=> "<a href=\"forum.php?mod=viewthread&do=tradeinfo&tid=$_G[tid]&pid=$pid\">".dhtmlspecialchars($_GET['item_name'])."</a>",
