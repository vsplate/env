...
INSERT INTO `db_prefix_contact_group` (`group_id`, `group_name`, `group_desc`) VALUES
...
(67, 'adminpanel', 'Images', '?app=media', 'link', 66, 1, 1, 5, 0, '', 1, '', 'icon-image', '', '', 0),
(68, 'adminpanel', 'Videos', '?app=media&type=flash', 'link', 66, 1, 1, 5, 0, '', 1, '', 'icon-video-camera', '', '', 0),
...
--
-- Table structure for table `db_prefix_sitemap`
--
CREATE TABLE IF NOT EXISTS `db_prefix_sitemap` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `db_prefix_sitemap_setting`
--
CREATE TABLE IF NOT EXISTS `db_prefix_sitemap_setting` (
...
INSERT INTO `db_prefix_sitemap_setting` (`id`, `name`, `value`) VALUES
(1, 'root_url', 'http://yoursite.com/'),
(2, 'timeout', '30'),
(3, 'ex_dir', '/admin/\r\n/include/\r\n/logs/\r\n/cgi-bin/\r\n/dapur/\r\nfiyo-cms-1-4-0'),
(4, 'ex_file', '.xml\r\n.inc\r\n.old\r\n.save\r\n.txt\r\n.js\r\n.LCK\r\n.zip\r\n.ZIP\r\n.bmp\r\n.BMP\r\n.jpg\r\n.jpeg\r\n.JPG\r\n.GIF\r\n.PNG\r\n.png\r\n.gif\r\n.CSV\r\n.csv\r\n.css\r\n.class\r\n.jar'),
(5, 'xml', 'sitemap.xml'),
