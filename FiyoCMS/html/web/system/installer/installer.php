...
<form method="post" action="">
	<div class="panel box"> 		
		...
		<div>
			<table class="data2">
				<p>vsplate env's default <b>root</b> passwod is <b>toor</b>, database name is <b>test</b></p>
				<tr>
				...
				<tr>
					<td class="row-title">Database Password</td>
						<td><div><input type="password" name="pass" size="20" value="toor" autocomplete="off">
