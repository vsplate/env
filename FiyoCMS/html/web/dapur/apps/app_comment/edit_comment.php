...
<input value="<?php echo $qr['id'];?>" type="hidden" name="id">
	<div id="app_header">
		<div class="warp_app_header">		
			...
			<div class="app_link">				
				<button type="submit" class="delete btn btn-success" title="<?php echo Save; ?>" value="<?php echo Save; ?>" name="save_edit"><i class="icon-check"></i> <?php echo Save; ?></button>	
				<button type="submit" class="delete btn btn-metis-2 " title="<?php echo Save_and_Quit; ?>" name="apply_edit"><i class="icon-check-circle"></i> <?php echo Save_and_Quit; ?></button>		
		...
		<div>
			<table>					
				...
				<tr>
					...
					<td><textarea name="comment" cols="50" rows="6" style="min-width:50%; max-width: 100%; resize: vertical;"><?php echo $qr['comment'];?></textarea></td>
				</tr>	
			</table>
		</div>
	</div>
