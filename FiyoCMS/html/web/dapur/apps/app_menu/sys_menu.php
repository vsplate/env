...
if(isset($_POST['save_add']) or isset($_POST['apply_add'])){	
	...
	if( !empty($_POST['name']) AND 
		...
		$row=$db->insert(FDBPrefix.'menu',array("","$_POST[cat]",stripTags("$_POST[name]"),"$_POST[link]","$_POST[apps]","$_POST[parent_id]","$_POST[status]","$_POST[short]", "$_POST[level]","0", "$_POST[title]","$_POST[show_title]","$_POST[sub_name]","$_POST[class]","$_POST[style]","$parameter",""));
